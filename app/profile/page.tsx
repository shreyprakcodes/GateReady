...
const LOUNGE_OPTIONS: { value: string; label: string }[] = [
  ...
  return (
    ...
    >
      <div className="min-w-0">
        <p className="text-sm font-semibold" style={{ color: checked ? C.accent : C.text }}>
          {label}
        </p>
        {hint && (
...
function LoungeCheckbox({
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-medium" style={{ color: checked ? C.accent : C.text }}>
        {label}
      </span>
    </button>
  );
...
export default function ProfilePage() {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok) {
        setSaveErr(json.error ?? "Could not save profile");
        return;
      }
      ...
      <div className="max-w-md mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="space-y-5">
            ...
            >
              <SectionLabel>Travel Documents</SectionLabel>
            ...
            >
              ...
              <p className="text-[11px] mb-3 leading-relaxed" style={{ color: C.muted }}>
                Select all lounge networks you have access to. GateReady will highlight accessible lounges on your trip.
              </p>
              <div className="space-y-2">
